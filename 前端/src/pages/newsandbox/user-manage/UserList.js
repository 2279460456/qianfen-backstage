...
import UserForm from '../../../component/userlist';
...
export default function Userlist() {
  ...
  const handleupdate = (item) => {
    setTimeout(() => {
      ...
      updataForm.current.setFieldsValue(item)     //将要修改的对象的值填写到编辑框
    }, 0)
    setcurrent(item);
  }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        <UserForm roles={roles} regions={regions} updateDisabled={updateDisabled} ref={updataForm}></UserForm>
      </Modal>
    </div >
  )
}
